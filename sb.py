...
botStart = time.time()
#cl = LINE()
cl = LINE("cintaasmara417@gmail.com","cintaasmara01")
...
settings = {
    ...
    "autoRead": False,
    "lang":"JP",
    "commentPost": "LIKE & COMEN DONE \n Add my owner ID http://line.me/ti/p/~ekafiutama",
    "detectMention": True,
    ...
    data = {
            ...
            "contents": {
             ...
             "hero": {
               ...
               "action": {
                 "type": "uri",
                 "uri": "https://line.me/ti/p/~ekafiutama"
                 }
               },
                   "type": "bubble",
                   "body": {
...
def sendTextTemplateMaster(to, text):
  ...
  "styles": {
    ...
    "header": {
     ...
     "aspectRatio": "20:13",
     "aspectMode": "cover",
     "url": "https://f.top4top.io/p_1596zp4kd3.png",
     "size": "full",
     "margin": "xl"
  },
  "footer": {
      ...
      "contents": [{
          ...
          "contents": [{
              ...
              "action": {
                  "type": "uri",
                  "label": "O",
                  "uri": "http://line.me/ti/p/~ekafiutama"
              }
          }, {
              "flex": 3,
              "type": "button",
...
def clBot(op):
  ...
  "contents": [
    {
      ...
      "body": {
        "contents": [
          ...
          {
            "type": "image",
        "url": "https://f.top4top.io/p_1596zp4kd3.png", #hp
        "aspectRatio": "2:1",
        "aspectMode": "cover",
        "size": "full",
          },
  ...
  "type": "carousel"
                        	...
                        	if settings["responsticker"] == True:
                                    ...
                                    data = {
                                                ...
                                                "template": {
                                                   ...
                                                   "columns": [
                                                    {
                                                        "imageUrl": "https://tenor.com/view/brown-cony-line-cute-love-gif-12488777.gif",
                                                        "size": "full", 
                                                        "action": {
                                                            "type": "uri",
                                                            "uri": "http://line.me/ti/p/~ekafiutama"
                    ...
                    start = time.time()
                    cl.sendMessage(to, "eka⭐")
                    cl.sendMessage(to, "fiu⭐⭐")
                    cl.sendMessage(to, "tama⭐⭐⭐")
                    ...
                    try:
                        arr = []
                        owner = "u9f8b411bfb65c42fdb6170fd38a252b2"
                        ...
                        ret_ += "\n╠ Version : Free v 1.1 by Eka fiutama"
                  ...
                  "uri": search_url
                    ...
                    if msg.toType == 2:
                             ...
                             for x in range(jmlh):
                                 ...
                                 sendTextTemplate(msg.to, "oke by ekafiutama")
                                    ...
                                    for music in a["items"]:
                                        ret_.append({
                                            ...
                                            "hero": {
                                                ...
                                                "action": {
                                                    "type": "uri",
                                                    "uri": "line://nv/profilePopup/mid=u9f8b411bfb65c42fdb6170fd38a252b2"
                                                }
                                            },
                                            "body": {
                                                "type": "box",
                   ...
                   if settings["notifikasi"] == False:
                    ...
                    settings["Sider"] = True
                    sendTextTemplate(msg.to,"Sider on")

                elif text.lower() == 'sider off':
                    if msg.to in cctv['point']:
                       cctv['cyduk'][msg.to]=False
                       settings["Sider"] = False
                       sendTextTemplate(msg.to,"sider off")
                    else:
                        sendTextTemplate(msg.to,"sider off")
